...
- Only make PiHole configuration changes to the primary gateway, the configuration in [synced](https://github.com/enclave-networks/internet-gateway/blob/main/template/docker-compose.primary.yml#L124) to the secondary every 30 minutes.
